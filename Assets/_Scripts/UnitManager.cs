...
public class UnitManager : MonoBehaviour
{
    ...
    public void spawnObjects()
    {
        ...
        var paperCount = 2;
        var rockCount = 1;
        var totalCount = rockCount + paperCount + paperCount;

        tileToBaseUnit = new Dictionary<Tile, BaseUnit>();

        List<Vector2> scissorList = new List<Vector2> {new Vector2(2, 3)};
        ...
        List<Vector2> rockList = new List<Vector2> { new Vector2(3, 1) };
        ...
        List<Vector2> paperList = new List<Vector2> { new Vector2(2, 2) ,new Vector2(1,0) };
